...
public class Graphics
    ...
    public void paintComponent(java.awt.Graphics g) {
        ...
        if(state == "START") {
            ...
            g2d.drawString("Press Any Key to start.....", Game.width/2 * Game.dimension - 90, Game.height / 2 * Game.dimension - 20);
            g2d.drawString("Controls are W=up, S=down, A=left, D=right", Game.width/2 * Game.dimension - 140, Game.height / 2 * Game.dimension );
        }
